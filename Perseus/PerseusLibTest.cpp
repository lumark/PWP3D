...
int main(void)
{
	...
	ImageUtils::Instance()->LoadImageFromFile(camera, "../Files/Images/Red.png");

	//objects allocation + initialisation: 3d model in obj required
	Object3D **objects = new Object3D*[objectCount];
	objects[objectIdx] = new Object3D(objectId, viewCount, "../Files/Models/Renderer/long.obj", width, height);

	//views allocation + initialisation: camera calibration (artoolkit format) required
	View3D **views = new View3D*[viewCount];
	views[viewIdx] = new View3D(0, "../Files/CameraCalibration/900nc.cal", width, height);
	...
	ImageUtils::Instance()->LoadImageFromFile(views[viewIdx]->videoMask, "../Files/Masks/480p_All_VideoMask.png");
	ImageUtils::Instance()->LoadImageFromFile(objects[objectIdx]->histSources[viewIdx], "../Files/Masks/Red_Source.png");
	ImageUtils::Instance()->LoadImageFromFile(objects[objectIdx]->histMasks[viewIdx], "../Files/Masks/Red_Mask.png", objectIdx+1);
